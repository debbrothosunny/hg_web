...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> About Tables</h4>
            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse ($about as $postData)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $postData->title }}</td>
                                <td>{!! Str::limit($postData->sub_title, '30', '...') !!}</td>
                                <td>{!! Str::limit($postData->description, '30', '...') !!}</td>
                                <td>{!! Str::limit($postData->video, '30', '...') !!}</td>
                                <td>
                ...
                <form action="{{ route('about.create') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row g-2">
                            ...
                            <div class="col mb-0">
                                <label for="dobLarge" class="form-label">Sub Title</label>
                                <input type="text" id="dobLarge" class="form-control" name="sub_title"
                        ...
                        <div class="row g-2">
                            <div class="col mb-0">
                                <label for="dobLarge" class="form-label">Video Link</label>
                                <input type="text" id="dobLarge" class="form-control" name="video"
                            ...
                            <div class="col mb-3">
                                <label for="nameLarge" class="form-label">Image <span>450*500</span></label>
        ...
        <div class="modal fade" data-bs-backdrop="static" id="{{'Edit'.$postData->id.'update'}}" tabindex="-1"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('about.update',$postData->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="row g-2">
                                <div class="col mb-0">
        ...
        <div class="modal fade" data-bs-backdrop="static" id="{{'dlt'.$postData->id.'delete'}}" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('about.delete',$postData->id) }}" method="get" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
