...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Sevices Tables</h4>
                        ...
                        <div class="collapse navbar-collapse" id="navbar-ex-4">
                            ...
                            <form class="d-flex">
                                <div class="input-group">
                                    <span class="input-group-text"><i class="tf-s bx bx-search"></i></span>
                                ...
                                <td>
                                    <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                            ...
                                            <img src="{!! asset('assets/img/uploaded/about/' . $postData->image_1) !!}" alt="Avatar" class="rounded-circle">
                                        </li>
                                    </ul>
                                </td>
    ...
    <div class="modal fade" data-bs-backdrop="static" id="largeModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('about.service.create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row g-2">
                            <div class="col mb-3">
                                <label for="nameLarge" class="form-label">Image <span>610*550</span></label>
                            ...
                            <div class="col mb-0">
                                <label for="dobLarge" class="form-label">Title 1</label>
                                <input type="text" id="dobLarge" class="form-control" name="title_1"
                                    placeholder=" Title" />
                                <span class="text-danger">
                                    @error('title_1')
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col mb-0">
                                <label for="emailLarge" class="form-label">Description 1</label>
                        ...
                        <div class="row g-2">
                            <div class="col mb-3">
                                <label for="nameLarge" class="form-label">Image 2  <span>610*550</span></label>
                            ...
                            <div class="col mb-0">
                                <label for="dobLarge" class="form-label">Title 2</label>
                                <input type="text" id="dobLarge" class="form-control" name="title_2"
                                    placeholder=" Title" />
                                <span class="text-danger">
                                    @error('title_2')
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col mb-0">
                                <label for="emailLarge" class="form-label">Description 2</label>
                        ...
                        <div class="row g-2">
                            <div class="col mb-3">
                                <label for="nameLarge" class="form-label">Image 3  <span>610*550</span></label>
                            ...
                            <div class="col mb-0">
                                <label for="dobLarge" class="form-label">Title 3</label>
                                <input type="text" id="dobLarge" class="form-control" name="title_3"
                                    placeholder="Title" />
                                <span class="text-danger">
                                    @error('title_3')
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col mb-0">
                                <label for="emailLarge" class="form-label">Description 3</label>
    ...
    @foreach ($service as $postData)
        <div class="modal fade" data-bs-backdrop="static" id="{{'Edit'.$postData->id.'update'}}" tabindex="-1"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel3">Services Update</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{ route('about.service.update',$postData->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="col mb-0">
                            ...
                            <div class="row">
                                <div class="col mb-0">
                                    <label for="emailLarge" class="form-label">Description 1</label>
                                    <textarea name="description_1" class="form-control">{{ $postData->description_1 }}</textarea>
                                    <span class="text-danger">
                                        @error('description_1')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col mb-0">
                                    <label for="emailLarge" class="form-label">Description 2</label>
                                    <textarea name="description_2" class="form-control">{{ $postData->description_2 }}</textarea>
                                    <span class="text-danger">
                                        @error('description_2')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col mb-0">
                                    <label for="emailLarge" class="form-label">Description 3</label>
                                    <textarea name="description_3" class="form-control">{{ $postData->description_3 }}</textarea>
                                    <span class="text-danger">
                                        @error('description_3')
                                            {{ $message }}
                                        @enderror
        ...
        <div class="modal fade" data-bs-backdrop="static" id="{{'dlt'.$postData->id.'delete'}}" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('about.service.delete',$postData->id) }}" method="get" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
